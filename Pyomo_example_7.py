#Spherical coordinates (PDE solve)
...
m.dTdt   = DerivativeVar(m.T, wrt=m.t) #dT/dt
m.dTdr   = DerivativeVar(m.T, wrt=m.r) #dT/dr
m.d2Tdr2 = DerivativeVar(m.T, wrt=(m.r, m.r)) #d2T/dr2
